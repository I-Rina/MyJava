...
public class Main {
	...
	public static void main(String[] args) {
		...
		btnNewButton.setIcon(new ImageIcon("Image//button.jpg"));
		...
		button.setIcon(new ImageIcon("Image//button.jpg"));
		...
		button_1.setIcon(new ImageIcon("Image//button.jpg"));
		...
		button_2.setIcon(new ImageIcon("Image//button.jpg"));
		...
		button_3.setIcon(new ImageIcon("Image//button.jpg"));
		...
		button_4.setIcon(new ImageIcon("Image//button.jpg"));
		...
		button_5.setIcon(new ImageIcon("Image//button.jpg"));
		...
		button_6.setIcon(new ImageIcon("Image//button.jpg"));
		...
		button_7.setIcon(new ImageIcon("Image//button.jpg"));
